...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T> 
{
     ...
     * 
     */
    public static final String TREE = "Binary Tree";
    ...
    public T getRootElement() throws EmptyCollectionException 
    {
        ...
        return myRoot.getElement(); // temporary null return just to get the
                                    // code to compile
    }
    ...
    public int size() 
    {
        final Iterator<T> iterator = iteratorInOrder();
        int count = 0;
        ...
        // return myModCount; // temporary return just to get the code to
        // compile
    }
    ...
    public int getHeight() 
    {
        ...
        return getHeight(myRoot);
    }

    /**
     * 
     * @param theNode Binanry Node.
     * @return return the number of node below that node
     */
    public int getHeight(final BinaryTreeNode<T> theNode) 
    {
        int count = 0;
        if (theNode == null) 
        {
        ...
        {
            count = Math.max(getHeight(theNode.myLeft) + 1, getHeight(theNode.myRight) + 1);
        }
        return count;
    }
    ...
    {
        // To be completed as a Programming Project
        return find(theTargetElement) != null;
    }
    ...
    public String toString() 
    {
        ...
        final Iterator<T> list = iteratorInOrder();
        while (list.hasNext()) 
        {
            string.append(list.next() + " ");
        }
    ...
    public int countLeafNodes() 
    {
        ...
        return countLeafNodes(myRoot);
    }

    /**
     * 
     * @param theNode current Node
     * @return number of LeafNodes
     */
    protected int countLeafNodes(final BinaryTreeNode<T> theNode) 
    {
        int count = 0;
        if (theNode == null) 
        {
        ...
        {
            count = countLeafNodes(theNode.myLeft) + countLeafNodes(theNode.myRight);
        }
        return count;
    }
